...
def get_disease():
    ...
    if (disease_json['data']=='Heart attack' or disease_json['data']=='Bronchial Asthma' or disease_json['data']=='Gastroenteritis') and len(symptoms) < 5:
        response = """
            People with COVID-19 can have symptoms similar to those of a heart attack or bronchial asthma, thus I can't know exactly whether you have the coronavirus or not. 
